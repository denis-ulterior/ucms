...
<section class="wrap">
  <form method="post" action="<?php echo Uri::to('uladmin/comments/edit/' . $comment->id); ?>" novalidate>
    ...
    <aside class="buttons">
        ...
        <?php echo Html::link('uladmin/comments', __('global.cancel'), ['class' => 'btn cancel blue']); ?>

        <?php echo Html::link('uladmin/comments/delete/' . $comment->id, __('global.delete'), [
