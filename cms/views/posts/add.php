...
<form method="post" action="<?php echo Uri::to('uladmin/posts/add'); ?>" enctype="multipart/form-data" novalidate>
    ...
    <fieldset class="header">
        <div class="wrap">
            ...
            <aside class="buttons">
                ...
                <?php echo Html::link('uladmin/posts', __('global.cancel'), array(
