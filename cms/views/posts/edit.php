...
<form
  method="post"
  action="<?php echo Uri::to('uladmin/posts/edit/' . $article->id); ?>"
  ...
  <fieldset class="header">
    <div class="wrap">
      ...
      <aside class="buttons">
          ...
          <?php echo Html::link('uladmin/posts', __('global.cancel'), [
              'class' => 'btn cancel blue'
          ]); ?>

          <?php echo Html::link('uladmin/posts/delete/' . $article->id, __('global.delete'), [
...
<script src="<?php echo asset('cms/views/assets/js/dragdrop.js'); ?>"></script>
...
<script src="<?php echo asset('cms/views/assets/js/change-saver.js'); ?>"></script>
