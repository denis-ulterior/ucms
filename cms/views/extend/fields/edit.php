...
<section class="wrap">
  <form method="post" action="<?php echo Uri::to('uladmin/extend/fields/edit/' . $field->id); ?>" novalidate>
    ...
    <aside class="buttons">
        ...
        <?php echo Html::link('uladmin/extend/fields', __('global.cancel'), ['class' => 'btn cancel blue']); ?>

        <?php echo Html::link('uladmin/extend/fields/delete/' . $field->id,
...
<script src="<?php echo asset('cms/views/assets/js/custom-fields.js'); ?>"></script>
