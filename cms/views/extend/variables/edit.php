<?php echo $header; ?>
  ...
  <section class="wrap">
    <form method="post" action="<?php echo Uri::to('uladmin/extend/variables/edit/' . $variable->key); ?>" novalidate>
      ...
      <aside class="buttons">
          ...
          <?php echo Html::link('uladmin/extend/variables', __('global.cancel'), ['class' => 'btn cancel blue']); ?>

          <?php echo Html::link('uladmin/extend/variables/delete/' . $variable->key,
