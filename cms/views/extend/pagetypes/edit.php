<?php echo $header; ?>
  ...
  <section class="wrap">
    <form method="post" action="<?php echo Uri::to('uladmin/extend/pagetypes/edit/' . $pagetype->key); ?>" novalidate>
      ...
      <aside class="buttons">
          ...
          <?php echo Html::link('uladmin/extend/pagetypes', __('global.cancel'), ['class' => 'btn cancel blue']); ?>

          <?php if ($pagetype->key != 'all'): ?>
              <?php echo Html::link('uladmin/extend/pagetypes/delete/' . $pagetype->key,
