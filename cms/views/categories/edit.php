...
<section class="wrap">
  <form method="post" action="<?php echo Uri::to('uladmin/categories/edit/' . $category->id); ?>" novalidate>
    ...
    <aside class="buttons">
        ...
        <?php echo Html::link('uladmin/categories', __('global.cancel'), ['class' => 'btn cancel blue']); ?>

        <?php echo Html::link('uladmin/categories/delete/' . $category->id, __('global.delete'), [
