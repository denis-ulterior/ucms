...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo asset('cms/views/assets/img/favicon.png'); ?>"/>

    <script src="<?php echo asset('cms/views/assets/js/zepto.js'); ?>"></script>

    <link rel="stylesheet" href="<?php echo asset('cms/views/assets/css/admin.min.css'); ?>">
  ...
  <body class="<?php echo Auth::guest() ? 'login' : 'admin'; ?> <?php echo str_replace('_', '-',
    ...
    <header class="top">
      <div class="wrap">
            ...
            <nav>
              <ul>
                <li class="logo">
                    ...
                    ?>
                  <a href="<?php echo Uri::to('uladmin/' . $page); ?>">Ulterior CMS</a>
                </li>
                  ...
                  <?php foreach ($menu as $url): ?>
                    <li <?php if (strpos(Uri::current(), $url) !== false) {
                      ...
                      <a href="<?php echo Uri::to('uladmin/' . $url); ?>">
              ...
              <?php echo Html::link('uladmin/logout', __('global.logout'), ['class' => 'btn']); ?>
          ...
          <?php else: ?>
            <aside class="logo">
              <a href="<?php echo Uri::to('uladmin/login'); ?>">Ulterior CMS</a>
            </aside>
          <?php endif; ?>
      </div>
    </header>
