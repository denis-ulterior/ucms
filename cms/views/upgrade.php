...
<html>
  ...
  <body>
    <div id="start">
      <img src="<?php echo $base; ?>/cms/views/assets/img/logo.png" alt="cms logo">
        ...
        <?php if ($compare < 0) : // new release available ?>
          ...
          <a href="<?php echo $base; ?>/uladmin"><?php echo __('global.upgrade_later'); ?></a>
        <?php elseif ($compare == 0) : // same version as newest ?>
          <h1><?php echo __('global.good_news'); ?></h1>
          <p><?php echo __('global.up_to_date'); ?></p>
          <p><?php echo VERSION; ?></p>
          <a href="<?php echo $base; ?>/uladmin"><?php echo __('global.upgrade_finished_thanks'); ?></a>
        ...
        <?php else : // SOMETHING'S WRONG! ?>
          ...
          <a href="<?php echo $base; ?>/uladmin"><?php echo __('global.error_button'); ?></a>
        <?php endif; ?>
    </div>
    <div id="loading" hidden>
      <img class="loadcms" src="<?php echo $base; ?>/cms/views/assets/img/logo.png" alt="cms logo">
      <h1><?php echo __('global.updating'); ?></h1>
    </div>
    <div id="finished" hidden>
      <img src="<?php echo $base; ?>/cms/views/assets/img/logo.png" alt="cms logo">
      <h1 class="fin_h1"></h1>
      <a class="fin_goBack" href="<?php echo Uri::to('uladmin/upgrade/'); ?>">Try again</a>
      <a class="fin_continue" href="<?php echo Uri::to('uladmin/'); ?>">Nevermind</a>
      <img class="dancing_robot" src="https://i.imgur.com/VKKeQX6.gif" alt="Gangnam Robot!"/>
    </div>
    <script type="text/javascript" src="<?php echo $base; ?>/cms/views/assets/js/zepto.js"></script>
    <script>
      var sendAjax;
      ( function ( $ ) {
        ...
        sendAjax = function () {
          $.ajax( {
                    url:     "<?php echo Uri::to('uladmin/upgrade/'); ?>",
                    type:    'POST',
