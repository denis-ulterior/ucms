...
<section class="wrap">
    ...
    <?php if (Auth::admin() || Auth::me($user->id)) : ?>
      <form
        method="post"
        action="<?php echo Uri::to('uladmin/users/edit/' . $user->id); ?>"
        novalidate
        autocomplete="off"
      ...
      >
        ...
        <aside class="buttons">
            ...
            <?php echo Html::link('uladmin/users', __('global.cancel'), ['class' => 'btn cancel blue']); ?>

            <?php echo Html::link('uladmin/users/delete/' . $user->id, __('global.delete'),
    ...
    <?php else : ?>
      ...
      <br><a class="btn" href="<?php echo Uri::to('uladmin/users'); ?>">Go back</a>
    <?php endif; ?>
</section>
