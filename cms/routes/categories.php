...
Route::collection(['before' => 'auth,csrf,install_exists'], function () {
     ...
     * List Categories
     */
    Route::get(['uladmin/categories', 'uladmin/categories/(:num)'], function ($page = 1) {
     ...
     * Edit Category
     */
    Route::get('uladmin/categories/edit/(:num)', function ($id) {
    ...
    Route::post('uladmin/categories/edit/(:num)', function ($id) {
        ...
        if ($errors = $validator->errors()) {
            ...
            return Response::redirect('uladmin/categories/edit/' . $id);
        }
     ...
     * Add Category
     */
    Route::get('uladmin/categories/add', function () {
        $vars['token'] = Csrf::token();
    ...
    Route::post('uladmin/categories/add', function () {
        $input = Input::get(['title', 'slug', 'description']);
        ...
        if ($errors = $validator->errors()) {
            ...
            return Response::redirect('uladmin/categories/add');
        }
        ...
        return Response::redirect('uladmin/categories');
    });

    /**
     * Delete Category
     */
    Route::get('uladmin/categories/delete/(:num)', function ($id) {
