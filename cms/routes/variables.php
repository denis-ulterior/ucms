...
Route::collection(['before' => 'auth,csrf,install_exists'], function () {
     ...
     * List Vars
     */
    Route::get('uladmin/extend/variables', function () {
     ...
     * Add Var
     */
    Route::get('uladmin/extend/variables/add', function () {
        $vars['token'] = Csrf::token();
    ...
    Route::post('uladmin/extend/variables/add', function () {
        $input        = Input::get([
            'key',
            'value'
        ]);
        ...
        if ($errors = $validator->errors()) {
            ...
            return Response::redirect('uladmin/extend/variables/add');
        }
        ...
        return Response::redirect('uladmin/extend/variables');
    });

    /**
     * Edit Var
     */
    Route::get('uladmin/extend/variables/edit/(:any)', function ($key) {
    ...
    Route::post('uladmin/extend/variables/edit/(:any)', function ($key) {
        ...
        if ($errors = $validator->errors()) {
            ...
            return Response::redirect('uladmin/extend/variables/edit/' . $key);
        }
     ...
     * Delete Var
     */
    Route::get('uladmin/extend/variables/delete/(:any)', function ($key) {
        Query::table(Base::table('meta'))
             ->where('key', '=', $key)
             ->delete();
