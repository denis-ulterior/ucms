...
class update
{
     ...
     */
    const UPDATE_URL = 'https://cms.ulteriorti.com.br/version';
    ...
    public static function upgrade($url, $version)
    {
        ...
        $result        .= '|-|Creating \'cms_update\' folder.';
        $output_folder = PATH . "cms_update" . DS;
        $output_file   = $output_folder . "cms_$version.zip";
        ...
        try {
            ...
            if (($zipCode = $zip->open($output_file)) === true) {
                ...
                $result .= '|-|Recursive copy of \'/cms/\', \'/system/\', and \'/index.php\'.';

                recurse_copy($output_folder . "cms", APP);
                ...
                throw new Exception("Cannot open the downloaded archive (CODE: $zipCode) - you may need to extract the contents manually!.");
            }
