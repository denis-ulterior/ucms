...
<html lang="pt-BR">
	<head>
		...
		<link rel="stylesheet" href="cms/views/assets/css/bootstrap.min.css">
		<script src="cms/views/assets/js/bootstrap.min.js">
			...
			<header id="top">
				...
				<nav id="main" role="navigation">
					<ul>
						...
						<li class="tray">
							<a href="#tray" class="linky"><img src="<?php echo theme_url('img/categories.png'); ?>" alt="Categories" title="Ver posts por categoria"></a>
						</li>
					</ul>
				</nav>
			</header>
