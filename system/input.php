...
namespace System;
 //require( __DIR__ ."/../functions/filtrainput.php");
/**
 * Nano
...
class input
{
    ...
    public static function detect($method)
    {
        switch ($method) {
            ...
            case 'POST':
                //teste de segurança honeypot
                if(!empty($_POST['nome'])) die();
                //filtragem específica de entradas
                $limpo = filtrarinput(filter_input_array(INPUT_POST,FILTER_SANITIZE_STRING));
               // $limpo = $_POST;
                static::$array = $limpo;
                break;
