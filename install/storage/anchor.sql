...
('Sem categoria', 'semcategoria', 'Ainda não há nenhuma categoria aqui');

INSERT INTO `{{prefix}}categories` (`title`, `slug`, `description`) VALUES
('Destaques', 'destaques', 'Categoria dedicada aos itens das páginas');
...
INSERT INTO `{{prefix}}pages` (`slug`, `name`, `title`, `content`, `status`, `redirect`, `show_in_menu`, `menu_order`) VALUES
('home', 'Home', 'Página home modificada', 'Bem vindo!', 'published', '', '1', '0');
