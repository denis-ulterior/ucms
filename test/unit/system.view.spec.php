...
describe('view', function () {
    ...
    it('should render a view', function () {
     ...
     <html>
     	...
     	<body>
     		<div>
     			<img src="./cms/views/assets/img/logo.png" alt="CMS logo">
     			<h1></h1>
     		...
     		<script>
     			(function(d) {
     				...
     				d.cookie = \'cms-install-timezone=\' + v + \'; path=/\';
     			}(document));
     		</script>
     	</body>
     </html>'));
    ...
    it('should render a view with partials', function () {
     ...
     <html lang="en">
        <head>
                <meta charset="utf-8">
                <title> </title>
                <link rel="shortcut icon" type="image/png" href="/cms/cms/views/assets/img/favicon.png" />
     
                <script src="/cms/cms/views/assets/js/zepto.js"></script>
     
                <link rel="stylesheet" href="/cms/cms/views/assets/css/admin.min.css">
        ...
        <body class="admin ">
                ...
                <header class="top">
                        <div class="wrap">
                                                                <aside class="logo">
                                        <a href="/cms/index.php?route=/uladmin/login">U-CMS CMS</a>
                                </aside>
                                                        </div>
                </header>
